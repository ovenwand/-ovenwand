...
export type SidebarStoreManager<State extends SidebarState = SidebarState> = {
    subscribe(id: string, subscriber: Subscriber<State>, invalidate?: Invalidator<State>): Unsubscriber;
...
export const store: SidebarStoreManager = {
    subscribe(id: string, subscriber: Subscriber<SidebarState>, invalidate?: Invalidator<SidebarState>): Unsubscriber {
